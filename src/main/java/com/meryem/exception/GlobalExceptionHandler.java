...
import static com.meryem.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SpringMarathonAppException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> springMarathonHandler(SpringMarathonAppException springMarathonAppException){
        return new ResponseEntity<>(createErrorMessage(springMarathonAppException,springMarathonAppException.getErrorType()),
                springMarathonAppException.getErrorType().getHttpStatus());
    }
